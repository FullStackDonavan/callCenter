...
console.log("API received leadPhone:", leadPhone, "agentId:", agentId);
    ...
    const call = await client.calls.create({
      url: `https://27f784151170.ngrok-free.app/api/calls/bridge-agent?lead=${encodeURIComponent(
        leadPhone
      )}&agentId=${agent.id}`,
      to: agent.phone,
      from: process.env.TWILIO_PHONE_NUMBER!,
      statusCallback: "https://27f784151170.ngrok-free.app/api/calls/status",
